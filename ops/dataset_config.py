...
# ROOT_DATASET = '/apdcephfs/share_1016399/calweng/Datasets'  # '/data/jilin/'
ROOT_DATASET = '/apdcephfs/share_1290939/0_public_datasets/'
...
def return_something(modality):
    filename_categories = '/apdcephfs/share_1290939/0_public_datasets/sthv1/datalist/tsm/category.txt'
    if modality == 'RGB':
        root_data = '/dockerdata/frames'
       # root_data = ROOT_DATASET + 'sthv1/data/frames'
        filename_imglist_train = '/apdcephfs/share_1290939/0_public_datasets/sthv1/datalist/tsm/train_videofolder.txt'
        filename_imglist_val = '/apdcephfs/share_1290939/0_public_datasets/sthv1/datalist/tsm/val_videofolder.txt'
        prefix = '{:05d}.jpg'
    elif modality == 'Flow':
...
def return_k400(modality):
    filename_categories = 400
    if modality == 'RGB':
        root_data = '/dockerdata/frames'
        filename_imglist_train = '/apdcephfs/share_1290939/zixiaowang/research/dataset/k400/k400_train_videofolder.txt'
        filename_imglist_val = '/apdcephfs/share_1290939/zixiaowang/research/dataset/k400/k400_val_videofolder.txt'
      #  filename_imglist_train = 'k400/data/videos/k400_train_videofolder.txt'
      #  filename_imglist_val = 'k400/data/videos/k400_val_videofolder.txt'
        prefix = 'img_{:05d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix

def return_k200(modality):
    filename_categories = 200
    if modality == 'RGB':
        root_data = '/dockerdata/frames'
        filename_imglist_train = '/apdcephfs/share_1290939/zixiaowang/research/dataset/k200/k200_train_videofolder.txt'
        filename_imglist_val = '/apdcephfs/share_1290939/zixiaowang/research/dataset/k200/k200_val_videofolder.txt'
        prefix = 'img_{:05d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix
...
def return_dataset(dataset, modality):
    dict_single = {'jester': return_jester, 'something': return_something, 'somethingv2': return_somethingv2,
                   ...
                   'k400': return_k400, 'k200':return_k200 }
